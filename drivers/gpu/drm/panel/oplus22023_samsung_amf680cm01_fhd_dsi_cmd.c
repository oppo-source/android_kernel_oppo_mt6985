...
#include "oplus22023_samsung_amf680cm01_fhd_dsi_cmd.h"
#include "oplus_bl.h"
...
static struct mtk_panel_params ext_params[MODE_NUM] = {
	//fhd_sdc_60_mode
	{
		...
		.color_samsung_status = true,
		.color_loading_status = true,
		.color_2nit_status = true,
		.vendor = "AC068_P_1_A0011",
		.manufacture = "P_1",
		.cust_esd_check = 0,
		.esd_check_enable = 1,
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	//enable aod_en gpio 11 to 1.3V
	gpiod_set_value(ctx->aod1p3_enable_gpio, 1);
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	//enable aod_en 1.3V
	ctx->aod1p3_enable_gpio = devm_gpiod_get(ctx->dev, "aod_en", GPIOD_OUT_HIGH);
	...
	register_device_proc("lcd", "AC068_P_1_A0011", "P_1");
	strcpy(lcm_version,"AC068_P_1_A0011");
	strcpy(lcm_manufacture,"P_1");
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	DISP_INFO("adfrconfig=%d Successful\n", oplus_adfr_config);
	return ret;
}
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus22023_samsung_amf680cm01_fhd_dsi_cmd",
		.owner = THIS_MODULE,
