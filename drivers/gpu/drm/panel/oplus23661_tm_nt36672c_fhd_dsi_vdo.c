...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0x2B, 0x9E);
	...
	jdi_dcs_write_seq_static(ctx, 0x58, 0xDA);
	jdi_dcs_write_seq_static(ctx, 0x59, 0xD5);
	jdi_dcs_write_seq_static(ctx, 0x5A, 0xD3);
	jdi_dcs_write_seq_static(ctx, 0x5B, 0xC9);
	jdi_dcs_write_seq_static(ctx, 0x5C, 0xC3);
	jdi_dcs_write_seq_static(ctx, 0x5D, 0xBA);
	jdi_dcs_write_seq_static(ctx, 0x5E, 0xB6);
	jdi_dcs_write_seq_static(ctx, 0x5F, 0xB5);
	jdi_dcs_write_seq_static(ctx, 0x60, 0xAE);
	jdi_dcs_write_seq_static(ctx, 0x61, 0xAB);
	jdi_dcs_write_seq_static(ctx, 0x62, 0xAA);
	jdi_dcs_write_seq_static(ctx, 0x63, 0xA8);
	jdi_dcs_write_seq_static(ctx, 0x64, 0xA7);
	jdi_dcs_write_seq_static(ctx, 0x65, 0xA5);
