...
static const struct regulator_desc fan53870_regulators[] = {
	FAN53870_NLDO(1, "vin12",  800000),
	FAN53870_NLDO(2, "vin12",  800000),
	FAN53870_PLDO(3, "vin34", 1680000),
	FAN53870_PLDO(4, "vin34", 1680000),
	FAN53870_PLDO(5, "vin5",  1680000),
	FAN53870_PLDO(6, "vin6",  2690000),
	FAN53870_PLDO(7, "vin7",  2690000),
};
