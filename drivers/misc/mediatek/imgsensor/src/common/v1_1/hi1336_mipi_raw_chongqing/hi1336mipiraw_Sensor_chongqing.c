...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
    ...
    .i4Crop = { {24, 0}, {24, 0}, {24, 390}, {0, 0}, {0, 0}, {24, 0}, {0, 0}, {56, 408}, {104, 60}, {0, 0} },
};
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4160x2340 = {
    ...
    .iMirrorFlip = 0,
    .i4PosR =    {
                        {34, 5}, {50, 5}, {42, 17}, {58, 17},
                        {34, 21}, {50, 21}, {42, 33}, {58, 33},
                },
    .i4PosL =    {
                        {34, 9}, {50, 9}, {42, 13}, {58, 13},
                        {34, 25}, {50, 25}, {42, 29}, {58, 29},
                },
    .i4Crop = { {24, 0}, {24, 0}, {24, 390}, {0, 0}, {0, 0}, {24, 0}, {0, 0}, {56, 408}, {104, 60}, {0, 0} },
};
 ...
 static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    printk("kevin %s data=%0x\n",__func__,data);
    data = 0x0200;
    write_cmos_sensor(0x0202,data);
    ...
    *(feature_data + 2) = imgsensor_info.gain_type;
    ...
    case SENSOR_FEATURE_GET_PDAF_INFO:
        ...
        case MSDK_SCENARIO_ID_CUSTOM1:
            ...
            break;
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_4160x2340, sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
        case MSDK_SCENARIO_ID_CUSTOM3:
