 ...
 *
 ****************************************************************************/
#ifndef _IMX890LUNA_SENSOR_SETTING_H
#define _IMX890LUNA_SENSOR_SETTING_H
...
static u16 imx890luna_addition_setting[] = {
    0x4C15 ,0x07,
    0x4C17 ,0x1B,
    0x4C1B ,0x03,
    0x4C1F ,0x02,
...
static u16 imx890luna_init_setting[] = {
    //Power ON
    //Input EXTCLK
    //XCLR OFF
...
static u16 imx890luna_preview_setting[] = {
    //QBIN_Vbin_30FPS
  //H: 4096
  //V: 3072
  //MIPI output setting
...
static u16 imx890luna_capture_setting[] = {
    //QBIN_Vbin_30FPS
  //H: 4096
  //V: 3072
  //MIPI output setting
...
static u16 imx890luna_normal_video_setting[] = {
  //H: 4096
  //V: 2304
  //MIPI output setting
    0x0112, 0x0A,
...
static u16 imx890luna_hs_video_setting[] = {
...
static u16 imx890luna_slim_video_setting[] = {
  //H: 2048
  //V: 1152 120fps
  //MIPI output setting
    0x0112, 0x0A,
...
static u16 imx890luna_custom1_setting[] = {
...
static u16 imx890luna_custom2_setting[] = {
  0x0112 ,0x0A,
  0x0113 ,0x0A,
  0x0114 ,0x02,
  0x0342 ,0x3D,
...
static u16 imx890luna_custom3_setting[] = {
    //QRMSC_11FPS
  //H: 8192
  //V: 6144
  //MIPI output setting
...
static u16 imx890luna_custom4_setting[] = {
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x02,
    0x0342, 0x3D,
...
static u16 imx890luna_custom5_setting[] = {
  //H: 4096
  //V: 3072
  //MIPI output setting
    0x0112, 0x0A,
...
static u16 imx890luna_custom6_setting[] = {
...
static u16 imx890luna_custom7_setting[] = {
    //H: 4096
    //V: 2304
    //MIPI output setting
    0x0112, 0x0A,
...
static u16 imx890luna_custom8_setting[] = {
    //H: 4096
    //V: 2304
    //MIPI output setting
    0x0112, 0x0A,
...
/* Reg_B_4096x3072_30FPS */
static u16 imx890luna_custom9_setting[] = {
    //H: 4096
    //V: 2304
    //MIPI output setting
    0x0112, 0x0A,
...
static u16 imx890luna_custom10_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
	0x0342, 0x2D,
...
*/
static u16 imx890luna_custom11_setting[] = {
  0x0112 ,0x0A,
  0x0113 ,0x0A,
  0x0114 ,0x02,
  0x0342 ,0xB7,
...
static u16 imx890luna_custom12_setting[] = {
    //H: 4096
    //V: 2304
    //MIPI output setting
    0x0112, 0x0A,
...
/* Reg_Q-2-1_4096x2304_30FPS, 16:9 for explorer*/
static u16 imx890luna_custom13_setting[] = {
    //H: 4096
    //V: 2304
    //MIPI output setting
    0x0112, 0x0A,
...
static u16 imx890luna_custom14_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
	0x0342, 0x5A,
...
static u16 imx890luna_custom15_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
	0x0342, 0x3D,
...
static u16 imx890luna_custom16_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
	0x0342, 0x3D,
...
static u16 imx890luna_seamless_normal_video[] = {
...
static u16 imx890luna_seamless_capture[] = {
	PHASE_PIX_OUT_EN, 0x01,
...
static u16 imx890luna_seamless_custom4[] = {
...
static u16 imx890luna_seamless_custom8[] = {
	// PHASE_PIX_OUT_EN, 0x03,
...
static u16 imx890luna_seamless_custom7[] = {
	// PHASE_PIX_OUT_EN, 0x01,
	FRAME_LEN_UPPER, 0x12,
	FRAME_LEN_LOWER, 0xBA,
	DOL_EN, 0x00,
...
static u16 imx890luna_seamless_custom9[] = {
	0x0342, 0x3D,
	0x0343, 0x00,
	0x0340, 0x0E,
	0x0341, 0xE2,
...
static u16 imx890luna_seamless_custom10[] = {
	0x0342, 0x2D,
	0x0343, 0x20,
	0x0340, 0x14,
	0x0341, 0x20,
...
static u16 imx890luna_seamless_custom11[] = {
	0x0342, 0x2D,
	0x0343, 0x20,
	0x0340, 0x19,
	0x0341, 0x28,
...
static u16 imx890luna_seamless_custom12[] = {
	0x0340, 0x0C,
	0x0341, 0x68,
	0x0202, 0x0A,
	0x0203, 0xA0,
...
static u16 imx890luna_seamless_custom13[] = {
	LINE_LEN_UPPER, 0x3D,
	LINE_LEN_LOWER, 0x00,
...
static u16 imx890luna_seamless_custom14[] = {
	LINE_LEN_UPPER, 0x5A,
	LINE_LEN_LOWER, 0x40,
...
static u16 imx890luna_seamless_custom15[] = {
...
static u16 imx890luna_seamless_custom16[] = {
	FRAME_LEN_UPPER, 0x0E,
