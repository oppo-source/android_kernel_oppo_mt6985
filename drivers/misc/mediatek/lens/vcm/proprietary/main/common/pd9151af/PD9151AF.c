...
#define AF_DRVNAME "PD9151AF_DRV"
...
static int s4PD9151AF_ReadReg(unsigned short *a_pu2Result)
{
	int  i4RetValue = 0;
    char pBuff[2];
	...
	if (i4RetValue < 0) 
    {
        LOG_INF("[FM50AF_PD9151P] I2C read failed!! \n");
        return -1;
    }
...
static int initdrv(void)
{
	...
	for (cmd_number = 0; cmd_number < 2; cmd_number++) {
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4PD9151AF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long PD9151AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int PD9151AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
...
int PD9151AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int PD9151AF_GetFileName(unsigned char *pFileName)
{
